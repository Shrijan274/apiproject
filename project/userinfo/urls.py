...
from userinfo.views import UserInfoViewSet,registeruser,UserLogin,userindex,Userlist,EditProfile,UserProfile,fileupload
...
urlpatterns = [
    ...
    path('filedata/',fileupload.as_view(),name='fileupload'),
